  ...
  <>
    ...
    <BlurW click={position}>
      <>
        ...
        <p className="pm">{``}</p>
        <p className="pm">{`I would wager, many of you have met or likely even know a person who though having their life in slight disarray, would not ever miss the chance to hit the gym for the 6th time that week and afterwards not limit themselves in sharing their experience of the "burn" that they endured.`}</p>
        <p className="pm">
        ...
        <p className="pm">{`That is why I think it's
