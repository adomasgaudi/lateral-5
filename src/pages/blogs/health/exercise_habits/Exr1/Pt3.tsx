  ...
  <>
    ...
    <BlurW click={position}>
      <>
        ...
        <p className="pm">{` There are at least two reasons that
        ...
        `}</p>
        <p className="pm">{`Second, the exercises might be clear but the muscle itself might be rarely used or simply not trained in a long time thus using it would be uncomfortable.`}</p>
        <p className="pm">
          {" "}
    ...
    <BlurW click={position}>
      <>
        ...
        <p className="pm">{`Ignoring the fact that a 50rep max is not optimal for muscle size/strength growth, there is still the problem that it's just exhausting. `}</p>
        <Quote>
    ...
    <BlurW click={position}>
      ...
      <p className="pm">discipline is just part of the equation</p>
    </BlurW>
  </>
);
